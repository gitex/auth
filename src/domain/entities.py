...
class Account:
    ...
    def change_password(
        ...
        """
        from src.domain.events import AccountPasswordChanged  # noqa: PLC0415
    ...
    def activate(self) -> AccountActivated:
        ...
        """
        from src.domain.events import AccountActivated  # noqa: PLC0415
    ...
    def deactivate(self) -> AccountDeactivated:
        ...
        """
        from src.domain.events import AccountDeactivated  # noqa: PLC0415
